package com.spring.mvc.RQB.mail;
...
public class SendEmail {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String to = "B024011010@gmail.com"; // 發送給誰 ? 若有多筆", "號隔開
        String title = "Welcom"; // 信件 title
        // 信件內容 
        String html = "<h1>Welcom to RQB</h1>";
    ...
    public void submit(String personal, String to, String title, String html) throws Exception {
        ...
        final String googleGmail = "B024011010@gmail.com"; // 你的 Gmail
        final String authPassword = "iecxlqyrgskcrqie"; // 你的授權碼
        ...
        prop.put("mail.smtp.starttls.enable", "true"); //TLS>>資訊加密
        ...
        InternetAddress ia = new InternetAddress("B024011010@gmail.com"); // 你的 Gmail
