        ...
        <script>
            $(document).ready(function () {
                $("#myTable").on("click", "tr", function () {
                    ...
                    //console.log(id);
                    $.get("${pageContext.request.contextPath}/mvc/RQB/item/" + id, function (data, status) {
                ...
                $("#add").on("click", function () {
                    ...
                    $.ajax({
                        url: "${pageContext.request.contextPath}/mvc/RQB/item/",
                        type: "POST",
                ...
                $("#del").on("click", function () {
                    ...
                    $.ajax({
                        url: "${pageContext.request.contextPath}/mvc/RQB/item/" + id,
                        type: "DELETE",
                        async: false, //Cross-domain requests and dataType: "jsonp" requests do not support synchronous operation
                        cache: false, //This will force requested pages not to be cached by the browser  
                        processData: false, //To avoid making query String instead of JSON
                        ...
                        <div class="content">
                            <form id="myform" class="pure-form">
                                <fieldset>
                                    ...
                                    <input id="symbol" name="symbol" placeholder="預計交期"/><p />
