...
<html>
    <head>
        ...
        <script src="${pageContext.request.contextPath}/RQB/js/util.js"></script>
    ...
    <center>
        <table bgcolor="#FFFFFF">
            <td valign="top">
                <form class="pure-form" method="post" action="${pageContext.request.contextPath}/mvc/RQB/login">
                    <fieldset>
            ...
            <td valign="top">
                <form id="regform" class="pure-form" method="post" action="${pageContext.request.contextPath}/mvc/RQB/login">
                    <fieldset>
