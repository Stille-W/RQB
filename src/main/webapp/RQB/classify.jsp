        ...
        <script>
            $(document).ready(function () {
                $("#myTable").on("click", "tr", function () {
                    ...
                    //console.log(id);
                    $.get("${pageContext.request.contextPath}/mvc/RQB/classify/" + id, function (data, status) {
                ...
                $("#add").on("click", function () {
                    ...
                    console.log(jsonStr);
                    $.ajax({
                        url: "${pageContext.request.contextPath}/mvc/RQB/classify/",
                        type: "POST",
                ...
                $("#upt").on("click", function () {
                    ...
                    console.log(jsonStr);
                    $.ajax({
                        url: "${pageContext.request.contextPath}/mvc/RQB/classify/" + jsonObj.id,
                        type: "PUT",
                        contentType: "application/json; charset=utf-8",
                        data: jsonStr,
                        async: true, 
                ...
                $("#del").on("click", function () {
                    ...
                    $.ajax({
                        url: "${pageContext.request.contextPath}/mvc/RQB/classify/" + id,
                        type: "DELETE",
                        async: true,
                        cache: false,
                        processData: false,
            ...
            function table_list() {
                $.get("${pageContext.request.contextPath}/mvc/RQB/classify/", function (datas, status) {
